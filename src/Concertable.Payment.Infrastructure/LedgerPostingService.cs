...
internal sealed class LedgerPostingService : ILedger
{
    ...
    public async Task<LedgerTransactionEntity> PostAsync(LedgerPosting posting, CancellationToken ct = default)
    {
