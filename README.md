...
dotnet build api/src/Concertable.Payment.Web/Concertable.Payment.Web.csproj
dotnet build api/src/Concertable.Payment.Workers/Concertable.Payment.Workers.csproj
```
