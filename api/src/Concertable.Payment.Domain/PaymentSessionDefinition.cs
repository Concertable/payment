...
internal sealed class PaymentSessionDefinition
{
    private PaymentSessionDefinition(
        Guid operationId,
    ...
    internal PaymentSessionDefinition WithOperationId(Guid operationId) =>
        Create(
            operationId,
            SessionKind,
            Session,
    ...
    public static PaymentSessionDefinition Create(
        Guid operationId,
        PaymentSessionKind sessionKind,
        PaymentSession session,
        string operationType,
        ...
        string? mandateTermsVersion)
    {
        ...
        clientReference = Normalize(clientReference, "Payment session client reference", 200);
