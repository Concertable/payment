...
public sealed class TransactionRepositoryAggregateTests : IClassFixture<PostgresFixture>
{
    private readonly PostgresFixture postgres;

    public TransactionRepositoryAggregateTests(PostgresFixture postgres)
    {
