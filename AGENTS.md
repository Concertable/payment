...
Adapter service — agnostic payment/ledger/escrow/payout, a shared runtime dependency of B2B + Customer (called over gRPC). Internal design → [`ARCHITECTURE.md`](./ARCHITECTURE.md) (read first, don't duplicate).
