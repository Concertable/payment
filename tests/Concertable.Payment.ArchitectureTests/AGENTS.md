# Concertable.Payment.ArchitectureTests — architecture tests

**Architecture fitness functions for Payment. The dynamic host-graph checks build the real production
