...
public sealed partial class ProviderContractInventoryTests
{
    ...
    [GeneratedRegex(@"\b(?<receiver>customerPaymentClient|managerPaymentOperationsClient|escrowOperationsClient|payoutAccountClient|paymentSessionOperationsClient)\.(?<operation>[A-Za-z_]\w*Async)\s*\(")]
