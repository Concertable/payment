...
public sealed class PaymentErrorDefinitionTests
{
    public static TheoryData<IError, string, string, ErrorKind> Cases => new()
    {
        ...
        { CommissionError.GrossNotConfirmed, "payment.commission_gross_not_confirmed", "The commission gross has not been confirmed.", ErrorKind.Conflict },
        { CommissionError.GrossMismatch, "payment.commission_gross_mismatch", "The commission gross does not match the confirmed amount.", ErrorKind.Conflict },
